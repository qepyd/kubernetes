...
```
## 编写manifests
cat >/tmp/clusterrolebind_chenliang02.yaml <<'EOF'
...
## 应用manifests
kubectl apply -f /tmp/clusterrolebind_chenliang02.yaml --dry-run=client
kubectl apply -f /tmp/clusterrolebind_chenliang02.yaml
